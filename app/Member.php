...
class Member extends Model
{
	...
	public function current_posting(){
        ...
        return $this->hasOne('App\PostingPromo', 'regt_num')->whereNotNull('new_posting')->orderBy('effective_date', 'desc');
        // ->select('new_posting as posting', 'effective_date', 'is_discharge')
    }
	public function current_rank(){
        return $this->hasOne('App\PostingPromo', 'regt_num')->whereNotNull('new_rank')->orderBy('effective_date', 'desc');
        // ->select('new_rank as rank', 'effective_date', 'is_acting')
    }
	public function current_platoon(){
        return $this->hasOne('App\PostingPromo', 'regt_num')->whereNotNull('new_platoon')->orderBy('effective_date', 'desc');
